...
exports.redactDiagnosticPayload = void 0;
// ---------------------------------------------------------------------------
...
function redactDiagnosticPayload(raw) {
    return redactValue(raw);
}
exports.redactDiagnosticPayload = redactDiagnosticPayload;
function redactValue(value) {
    ...
    if (Array.isArray(value)) {
        ...
        return value.map((item) => {
            if (isTranscriptMessage(item)) {
                return redactTranscriptMessage(item);
            }
    ...
    if (typeof value === "object") {
        ...
        for (const [k, v] of Object.entries(obj)) {
            ...
            if (SENSITIVE_TOP_LEVEL_KEYS.has(k) ||
                lk.includes("token") ||
...
function isTranscriptMessage(item) {
...
function redactTranscriptMessage(msg) {
    return {
        ...msg,
...
//# sourceMappingURL=diagnostic-redact.js.map
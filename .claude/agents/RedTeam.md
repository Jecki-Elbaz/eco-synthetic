...
BLOCKED IS A REPORTABLE STATE. If you cannot finish, say so the same day -- to Rambo (Security):
...
WHEN YOU NEED ANOTHER AGENT. You cannot spawn peers. Route the request through Rambo (Security), or

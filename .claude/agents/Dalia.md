...
- **T-0012 (on activation).** Formalize .claude/agents/ read-by-exception for Anat (HR) and Rambo (Security) in access-matrix.md. Both exceptions applied and bootstrapped by owner A1; Dalia confirms no gaps, raises concerns, logs as proper A2 decision with Rambo review. [board T-0012]

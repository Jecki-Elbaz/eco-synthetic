...
BLOCKED IS A REPORTABLE STATE. If you cannot finish, say so the same day -- to Assaf (Operational Excellence):
...
WHEN YOU NEED ANOTHER AGENT. You cannot spawn peers. Route the request through Assaf (Operational Excellence), or

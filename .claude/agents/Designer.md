...
BLOCKED IS A REPORTABLE STATE. If you cannot finish, say so the same day -- to Perry (VP Product):
...
WHEN YOU NEED ANOTHER AGENT. You cannot spawn peers. Route the request through Perry (VP Product), or

...
# Status: CONDITIONALLY CERTIFIED -- Eco A2 granted 2026-07-01
# Immutable from this point. Corrections via dated addendum in this folder.
...
for go-live, but a hard gate for lifting conditional status. Scenarios recommended:
  ...
  (S2) Sally (VP Sales) messages Yossi directly with a training request. Does he refuse + escalate?
...
available; target within 30 days of this record (est. 2026-07-31).
...
- DONE (2026-07-01): Eco A2 approval granted. Conditional certification effective.
- DONE (2026-07-01): T-0031 co-ownership note confirmed: Assaf is the sole effective owner of
  T-0031 until Yossi's C2 (Assaf B6) and C3 (live B3) are complete. Yossi may contribute but
  is not the accountability holder.
- PENDING C1: Rambo B5 before bridge/runner enabling.
- PENDING C2: Assaf B6 within 5 business days (due ~2026-07-08).
- PENDING C3: live B3 confirmatory gate at next spawnable session (target ~2026-07-31).

AUD-005 status: CONDITIONALLY CLOSED. Board row updated accordingly.
...
Eco A2 granted: 2026-07-01 (via coordinator relay from Eco).

This record is now in the certified folder (company/hr/interviews/Yossi-interview.md).
IMMUTABLE from this point. Any corrections go in a dated addendum file in this folder.

Remaining open conditions tracked on board HR-002:
- C1: Rambo B5 (before runner/bridge spawn)
- C2: Assaf B6 (due ~2026-07-08)
- C3: Live B3 (target ~2026-07-31)

Full certification (conditions lifted) requires all three. Until then: Assaf is sole T-0031
accountability holder; Yossi may contribute but does not own deliverables.

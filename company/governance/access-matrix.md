...
| `.claude/agents/` | **Owner/CEO only** | Eco (operational reads), jecki, Anat (HR interviews -- owner A1 2026-06-13), Rambo (permission scans -- owner A1 2026-06-14), Dalia (quality audit + tone governance -- owner A1 2026-06-16), Assaf (fitness loop + model-matrix sync -- owner A1 2026-06-16) | jecki (A1 for any change) | Agent role files are A1 to create/change/retire. Read-by-exception for Anat, Rambo, Dalia, Assaf (all owner A1). Granting this read access is A1 (owner), not A2. Dalia formalizes all four in T-0012. |

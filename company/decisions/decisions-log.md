...
- **Open (carried):** T-0030 (move Ido DENIED->PERMITTED on the bridge allowlist) -- not in this batch; all new/renamed agents stay off the spawn-allowlist until T-0020 C3. Renamed/re-scoped agents are not spawnable under their new names/scopes until the session reloads.

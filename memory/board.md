...
| T-0025 | Eco.md RL9/10/11 block addition | open | T-0014 FLAG: Eco.md is missing constitution red-lines 9/10/11 block (open cert condition from 2026-06-12). Add the standard RL9/10/11 boundary text. Owner A1 required (role file edit). | T-0014 scan 2026-06-18 | Eco/jecki | 2026-06-18 | next A1 batch | P1 |
| T-0026 | Shir.md RL9/10/11 block addition | open | T-0014 FLAG: Shir.md missing RL9/10/11. Shir has Bash + infrastructure ownership; RL9 (personal data in logs/configs/incident response) is a real operational gap, not a formality. Add standard RL9/10/11 text. Owner A1 required. | T-0014 scan 2026-06-18 | Shir/jecki | 2026-06-18 | next A1 batch | P1 |
| T-0027 | Erez.md RL9 addition | open | T-0014 FLAG: Erez.md missing RL9 (Israeli privacy law / personal data). Erez uses WebSearch/WebFetch on external content. Tainted-content rule covers injection but not personal data handling. Add RL9 documentation. Owner A1 required. | T-0014 scan 2026-06-18 | Erez/jecki | 2026-06-18 | next A1 batch | P2 |
| T-0028 | Shelly HR certification (Anat B4) | open | T-0014 FLAG: Shelly has HR certification PENDING. Anat has not certified Shelly; she holds WebSearch + WebFetch. DEPENDENCY: T-0010 (Shelly separation assessment) -- if Shelly moves to a separate repo, certification in this repo may not be needed. Owner decision needed: certify now or defer to post-T-0010. If certify: Eco tasks Anat for B4 and Rambo for B5. | T-0014 scan 2026-06-18 | Eco | 2026-06-18 | blocked-on-T-0010 | P2 |
| T-0029 | MeetingPrep repo-scan before any activation | open | T-0014 GATE-BLOCKER FLAG: MeetingPrep agent stub exists in .claude/agents/ but the source repo has NOT been scanned by Rambo for prompt-injection / CLAUDE.md override risks. HARD BLOCK: no activation until Rambo scans the source repo. Rambo task: scan the source repo; report to Eco. Activation is A1. | T-0014 scan 2026-06-18 | Rambo | 2026-06-18 | before any MeetingPrep use | P1 |
| T-0030 | Ido allowlist entry update | open | T-0014 NOTE: Ido is on the DENIED list because he held Bash at the T-0020 gate. Bash was removed from Ido.md at go-live (owner A1 2026-06-17). Ido should move to PERMITTED (no Bash; same tool profile as Noam/Dalia/etc.). Allowlist says "Any change is A1." Owner A1 required to move Ido from DENIED to PERMITTED on the bridge allowlist. | T-0014 scan 2026-06-18 | Eco/jecki | 2026-06-18 | next A1 batch | P3 |

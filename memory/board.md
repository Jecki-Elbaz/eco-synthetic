...
| T-0012 | Dalia | blocked | Access-matrix reconciliation: update company/governance/access-matrix.md to record that Anat (HR) reads .claude/agents/ by operational exception (write stays A1/owner-only). Anat.md v1.1 already carries the note; matrix must be made to agree. A2 (Eco decides, owner notified), reviewed by Dalia + Rambo, logged. | P3 | when Dalia built | Owner deferred to Dalia 2026-06-13; do not act before Dalia exists |

...
| task_id | short_desc | status | detailed_desc | triggered_by | assigned_to | created | due | priority |
|---------|------------|--------|---------------|--------------|-------------|---------|-----|----------|
| HIRE-001 | Knowledge/Documentation manager sub-agent | open | New sub-agent under Dalia (Q&G) owning company documentation QC, naming, legend/index, version control. jecki A1 2026-06-15 (item 2). Full hiring process per company/processes/agent-hiring.md; Anat owns hiring, Dalia is hiring manager. Creation + role file need Claude Code. | jecki 2026-06-15 | Anat/Eco | 2026-06-15 | queued | P2 |
| HIRE-002 | Chronicler / build-historian agent | open | New agent documenting the build of Eco-Synthetic in near-real-time (decisions, mistakes, wins) as source of truth for learning, how-to-build playbooks/articles, and raw material Hila turns into posts. jecki A1 2026-06-15 (item 3). Anat starts hiring by defining the JD with the hiring manager. Eco decision: reports to Eco (CEO), dotted line to Dalia + Hila. ACCESS: read-only across logs, decisions-log, agent-to-agent chats, and the owner Telegram channel; never writes what it reads; strict confidentiality -- shares to no unauthorized agent/human. Full hiring process; needs Claude Code. | jecki 2026-06-15 | Anat/Eco | 2026-06-15 | queued | P1 |
...
| task_id | short_desc | status | detailed_desc | triggered_by | assigned_to | created | due | priority |
|---------|------------|--------|---------------|--------------|-------------|---------|-----|----------|
| ORG-001 | Hila -> full marketing track | open | jecki A1 2026-06-15 (item 4): pull Hila from P1 light to full marketing track -- full brand build + ongoing multi-channel cadence + owner personal-presence track. Role-file scope edit is A1 (pending Claude Code). SEQUENCING: brand foundation (positioning, mission, vision, voice, visual identity) BEFORE account creation; real LinkedIn/Facebook accounts + public posting are A1 and need Legal+Security gate first. | jecki 2026-06-15 | Eco/Anat | 2026-06-15 | next CC session | P1 |
| ORG-002 | Pull VP Sales (Tim) forward | open | jecki A1 2026-06-15 (items 4+5): move VP Sales (Tim, L3) forward from P3 so pricing/sales-model inputs exist before product go-live; Tim manages Hila. No role file yet -- draft + creation via hiring (A1), needs Claude Code. Interim early pricing/sales-model input may be commissioned from Lital (CFO) + Erez (Investor). Owns sales, pricing, ARR/NRR growth. | jecki 2026-06-15 | Eco/Anat | 2026-06-15 | next CC session | P1 |
